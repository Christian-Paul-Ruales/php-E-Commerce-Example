...
<body class="bg-shape">
 ...
 ?>
  ...
  <?php
  $total=0;
  $sql_searh='SELECT "homepage-list homes" as p, (SUM(tiempo_pagina.tiempo)/COUNT(tiempo_pagina.tiempo)) AS time FROM `tiempo_pagina` WHERE pagina="homepage" and fin IS NOT NULL';
    $mys=mysqli_query($con, $sql_searh);

    $row=mysqli_fetch_assoc($mys);
  ?>
    <tr>
      <th scope="row"><?php echo $row['p']; ?></th>
  ...
  $sql_searh='SELECT "list homes - house details" as p, (SUM(tiempo_pagina.tiempo)/COUNT(tiempo_pagina.tiempo)) AS time FROM `tiempo_pagina` WHERE pagina="Accommodation list" and fin IS NOT NULL';
    $mys=mysqli_query($con, $sql_searh);
  ...
  ?>
    ...
    <?php
     $total=$total+$row['time'];
  $sql_searh='SELECT "house details - buy page" as p, (SUM(tiempo_pagina.tiempo)/COUNT(tiempo_pagina.tiempo)) AS time FROM `tiempo_pagina` WHERE pagina="house detail" and fin IS NOT NULL';
    $mys=mysqli_query($con, $sql_searh);
...
<?php
 $total=$total+$row['time'];
  $sql_searh='SELECT "buy page - finish buy" as p, (SUM(tiempo_pagina.tiempo)/COUNT(tiempo_pagina.tiempo)) AS time FROM `tiempo_pagina` WHERE pagina="purchase detail" and fin IS NOT NULL';
    $mys=mysqli_query($con, $sql_searh);
  ...
  ?>
    ...
    <?php
     $total=$total+$row['time'];
  $sql_searh='SELECT "To Login" as p, (SUM(tiempo_pagina.tiempo)/COUNT(tiempo_pagina.tiempo)) AS time FROM `tiempo_pagina` WHERE pagina="Log in" and fin IS NOT NULL';
    $mys=mysqli_query($con, $sql_searh);
