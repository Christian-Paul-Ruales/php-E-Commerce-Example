...
<body class="bg-shape">
  ...
  <tbody>
  <?php
  $sql_searh='SELECT * FROM `transacciones` WHERE transacciones.fin IS NOT NULL and transaccion="Compra"' ;
  ...
  ?>
    ...
    ?>
        ...
        $sql1 = "SELECT (SUM(total)/COUNT(total)) as media FROM `transacciones` WHERE transacciones.fin IS NOT NULL and transaccion=\"Compra\"";
        $mys1=mysqli_query($con, $sql1);
        $row=mysqli_fetch_assoc($mys1);
        echo "<h4>Average Time to make a purchase: ".$row['media']."</h4><br>";
        ?>
  ...
  <tbody>
  <?php
  $sql_searh='SELECT * FROM `transacciones` WHERE transacciones.fin IS NOT NULL and transaccion="Inicio Sesion"' ;
    $mys=mysqli_query($con, $sql_searh);
...
<?php
        ...
        $mys1=mysqli_query($con, $sql1);
        $row=mysqli_fetch_assoc($mys1);
        echo "<h4>Average time to log in: ".$row['media']."</h4><br>";
        ?>
    </div>
  </section>
  <!--================Service Area End =================-->
