...
<body class="bg-shape">
  ...
  <section class="section-margin generic-margin">
    <div class="container">
    <h1>Transactions not completed (Final Users)</h1>
    <table class="table">
  ...
  <tbody>
  <?php
  $sql_searh="SELECT * FROM transacciones WHERE transacciones.fin IS NULL and usuario <> 'User has not logged in'";
  ...
  ?>
    ...
    ?>
      ...
      <h1>Transactions not completed (Register and not)</h1>
      <table class="table">
  <caption>List of users</caption>
  <thead>
    <tr>
  ...
  <tbody>
  <?php
  $sql_searh="SELECT * FROM transacciones WHERE transacciones.fin IS NULL";
    $mys=mysqli_query($con, $sql_searh);
