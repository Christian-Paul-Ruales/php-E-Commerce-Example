...
<?php
 ...
 //print_r($las_user);
     ...
     if($las_user['tiempo']=="" && $las_user['pagina']!="homepage"){
     ...
     $sql = "INSERT INTO tiempo_pagina (usuario, pagina, inicio, fin, tiempo) VALUES ('".$usu."', 'homepage','".$fin."', NULL, NULL)";
              ...
              <form name="findHome" id="findHome" action="./alojamientos.php" method="get" onsubmit="return validate_search()">
                <div class="control-group">
                  <div class="form-group floating-label-form-group controls mb-0 pb-2">
                    <label>City</label>
                    <input class="form-control" id="city" name="city" type="text" placeholder="City" title="City you want to travel to">
                      <button type="button" id="helpCity" class="btn btn-outline-secondary" data-toggle="modal" data-target="#exampleModalCenter" style="font-size:13px;width:30px;height:30px;border-radius: 50px;" >
                        ?
                      </button>
                ...
                <div class="control-group">
                  <div class="form-group floating-label-form-group controls mb-0 pb-2">
                   ...
                   <label>Return Date</label> <br>
                    <input id="arrival_date" name="arrival_date" type="date" min="<?php 
                    $hoy=date("Y-m-d"); //echo $hoy; 
                   
                    $nuevafecha = strtotime ( '-1 day' , strtotime($hoy)) ;
                    $nuevafecha = date ( 'Y-m-d' , $nuevafecha );
                    echo $nuevafecha;
                    ?>" title="date of you arrival/check in on the house you rent">
                
                   
                      <input id="return_date" name="return_date" type="date" onclick="setDateFinal()" title="Return date to your home (Check out)">
                      <button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#ModalDates" style="font-size:13px;width:30px;height:30px;border-radius: 50px;">
                        ?
                      </button>
                ...
                <div class="control-group">
                  <div class="form-group floating-label-form-group controls mb-0 pb-2">
                    <div class="dropdown">
                    <label>Delegacy: </label>

                      
                      <button value="5" class="btn btn-secondary dropdown-toggle" type="button" name="dropdownMenuButtonnp" id="dropdownMenuButtonnp" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="With how many people do you travel? indicate it here">
                        delegacy
                      </button>
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonnp">
                          ...
                          <div class="form-group">
                            Adults
                            <input type="number" class="form-control" name="NumberAdult" id="NumberAdult" value="0" min="0"  onclick="peopleNumberCount()">
                          </div>
                          <div class="form-group">
                            Children
                            <input type="number" class="form-control" name="NumberChildren" id="NumberChildren" value="0" min="0"  onclick="peopleNumberCount()">
                          </div>
                          <div class="form-group">
                            Babies
                            <input type="number" class="form-control" name="NumberBabies" id="NumberBabies" value="0" min="0" onclick="peopleNumberCount()">
                          </div>
                         
                      </div>
                      <button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#ModalDelegacy" style="font-size:13px;width:30px;height:30px;border-radius: 50px;">
                        ?
                      </button>
                      <p id="err_people" class="help-block text-danger"></p>
                ...
                <div class="form-group">
                    ...
                    <input type="submit" class="btn btn-primary btn-xl" name="btnSearchHome" id="btnSearchHome" value="Find Home" > 
