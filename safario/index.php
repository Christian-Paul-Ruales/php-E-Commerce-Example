        ...
        <header>
          <div class="row">
            <div class="col-lg-12 mx-auto">
              <form name="findHome" id="findHome">
                <div class="control-group">
                  <div class="form-group floating-label-form-group controls mb-0 pb-2">
                    <label>City</label>
                    <input class="form-control" id="country" name="city" type="text" placeholder="City" required="required" data-validation-required-message="Please enter a City or Coutry you want to travel to.">
                ...
                <div class="control-group">
                  <div class="form-group floating-label-form-group controls mb-0 pb-2">
                   ...
                   <label>Return Date</label> <br>
                    <input id="arrival_date" type="date" placeholder="arrival_date" required="required" data-validation-required-message="Enter the date of your arrival at your destination">
                    
                    
                      <input id="return_date" type="date" placeholder="return_date" required="required" data-validation-required-message="Enter the date of your return at your home">
                      <p class="help-block text-danger"></p>
                    </div>
                  ...
                  <div class="form-group floating-label-form-group controls mb-0 pb-2">
                    ...
                    <label>Delegacy</label>
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <form class="px-4 py-3" id="numbers">
                          <div class="form-group">
                            Adults
                            <input type="number" class="form-control" id="NumberAdult">
                          </div>
                          <div class="form-group">
                            Children
                            <input type="number" class="form-control" id="NumberChildren">
                          </div>
                          <div class="form-group">
                            Babies
                            <input type="number" class="form-control" id="NumberBabies">
                          </div>
                ...
                <div class="form-group">
                    ...
                    <p><a href="alojamientos.php?var1=<?php echo $city;?>">Home</a></p>
