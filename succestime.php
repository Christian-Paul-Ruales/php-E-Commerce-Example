...
<body class="bg-shape">
 ...
 ?>
  ...
  <section class="section-margin generic-margin">
    <div class="container">
   <form action="succestime.php" method="get">
   <input type="text" name="txtTime" placeholder="TIME(Seconds) Ex. 60">
   <input type="submit" name="btntime" class="btn btn-primary" value="Find">
   </form>
   <?php
   $time=60;
    if(isset($_GET['btntime'])){
        $time=$_GET['txtTime'];
    }
   ?>
   <h3>Transactions in <?php echo $time; ?></h3><br>
    <table class="table">
  ...
  <tbody>
  <?php
  $sql_searh='SELECT * FROM `transacciones`where fin IS NOT NULL and total<='.$time;
